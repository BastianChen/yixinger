...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getPlaceDetailData: function getPlaceDetailData() {
      ...
      this.$httpWX.get({
        url: __WEBPACK_IMPORTED_MODULE_0__service_api_js__["a" /* apiurl */].getPlaceByUid,
        data: {
          uid: this.uid
        }
      }).then(function (res) {
        ...
        _this.introduce = _this.placeDetailData.place.introduce ? _this.placeDetailData.place.introduce : '暂无';
        _this.sugTime = _this.placeDetailData.place.sugTime ? _this.placeDetailData.place.sugTime : '暂无';
        _this.bestTime = _this.placeDetailData.place.bestTime ? _this.placeDetailData.place.bestTime : '暂无';

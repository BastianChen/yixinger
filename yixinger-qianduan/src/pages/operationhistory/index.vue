          ...
          <div v-for="(item, index) in photoDistinguishData" :key="index" style="margin: 10px 5px">
            <div v-if="item.year==year">
              <van-row>
                ...
                <van-col span="18" @longpress="clickLong(item.id,1)">
                  <van-card
                    :desc="item.desc"
                    :title="item.keyword"
                    :thumb="item.imageUrl"
          ...
          <div v-for="(item, index) in textDistinguishData" :key="index" style="margin: 10px 5px">
            <div v-if="item.year==year">
              <van-row>
                ...
                <van-col span="18" @longpress="clickLong(item.id,2)">
                  <van-card
                    :desc="item.desc"
                    :title="item.keyword"
                    :thumb="item.imageUrl"
        ...
        if (type == 1) {
          ...
          this.$httpWX.get({
            ...
            if (this.textDistinguishData == null) {
              ...
              console.log(this.textDistinguishData)
              console.log(this.yearsIntextDistinguish)
            }
          })
        }
      },

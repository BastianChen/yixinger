<template>
  <div class="index">
    ...
    <div class="secondDiv" @click="photoDistinguish()">
      <van-row>
        <van-col span="3" offset="1">
          <img src="../../../static/images/photo_distinguish.png"/>
        </van-col>
    ...
    <div class="fourthDiv" @click="textDistinguish()">
      <van-row>
        <van-col span="3" offset="1">
          <img src="../../../static/images/text_distinguish.png"/>
        </van-col>
        <van-col span="17" offset="2">
          <div class="firstCol">
            <span>

package com.cb.yixinger.utils.ai.client;

import com.cb.yixinger.utils.ai.auth.CloudAuth;
import com.cb.yixinger.utils.ai.auth.DevAuth;
import com.cb.yixinger.utils.ai.error.AipError;
import com.cb.yixinger.utils.ai.http.*;
import com.cb.yixinger.utils.ai.util.SignUtil;
...
public class BaseClient {
     ...
     *  为DEV创建的用户填充body
     */
    protected void preOperation(AipRequest request) throws JSONException {
        if (needAuth()) {
     ...
     */
    protected void postOperation(AipRequest request) throws JSONException {
        if (isBceKey.get()) {
            // add aipSdk param
     ...
     */
    protected JSONObject requestServer(AipRequest request) throws JSONException {
        // 请求API
